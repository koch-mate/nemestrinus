        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="dropdown-header">Lakossági</li>
                        <li><a href="/lakossagi-megrendeles-osszesites">Összesítés</a></li>
                        <li><a href="/lakossagi-megrendeles-attekintes">Áttekintés</a></li>
                        <li><a href="/uj-lakossagi-megrendeles">Új megrendelés</a></li>
                        <li role="separator" class="divider"></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/">Havi összesítő</a></li>
                        <li><a href="/">Vevőnkénti összesítés</a></li>
                        <li><a href="/">Fafajonkénti összesítés</a></li>
                        <li><a href="/">Gyártói statisztika</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/felhasznalok">Felhasználók</a></li>
                        <li><a href="/export-megrendelok">Export megrendelők</a></li>
