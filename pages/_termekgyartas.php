...
<table id="keszlet" class="table table-striped table-hover">
    ...
    <tbody>
        <tr>
            ...
            <td>30 cm</td>
            <td>ömlesztett</td>
            <td><span class="glyphicon glyphicon-tint"></span><span class="glyphicon glyphicon-tint"></span></td>
            <td>
...
<form class="form-horizontal">
    <fieldset>
        ...
        <div class="jumbotron">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="appendedtext">Kiszerelés</label>
                <div class="col-md-4">
...
<div class="container-fluid">
    ...
    <div class="starter-template" style="owerflow-x:auto;">
        ...
        <h1>Export megrendelések összesítése</h1>
