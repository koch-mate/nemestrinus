    ...
    <form class="form-horizontal" id="megr" name="megr" action="/?mode=lakossagi-uj-megrendeles" method="post">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                        <input class="form-control" name="idatum" id="idatum" type="dateISO" required placeholder="éééé-hh-nn" value="<?=date('Y-m-d', time()+((SZALLITASI_IDO[M_LAKOSSAGI]+GYARTASI_IDO[M_LAKOSSAGI][N_FRISS])*24*3600))?>">
                        <div class="input-group-addon">
                            <span class="glyphicon glyphicon-th"></span>
                        </div>
                    </div>
