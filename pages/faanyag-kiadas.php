...
if(!empty($_POST['cmennyiseg'])){
    woodAdd(
      ...
      $megrendelesTetelID=null);
    logEv(LOG_EVENT['wood_sell'].':',null,implode(', ',['RefID: '.$_POST['refID'],FATIPUSOK[$_POST['fatipus']][0], $_POST['cmennyiseg'].' '.U_NAMES[U_STD][0], $_POST['szlaszam'], $_POST['datum'], $_POST['megj'], $_POST['ekaer'], $_POST['cmr'], $_POST['fuvarozo']]));
