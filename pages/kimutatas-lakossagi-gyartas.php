...
<p>
  Az alábbi táblázat azokat az éppen aktuálisan a rendszerben lévő lakossági megrendeléseket mutatja, melyek már elfogadott státuszban vannak, de még van olyan tételük, amely nincs legyártva.
</p>
<style>
...
<table class="table">
  ...
  <tbody>
    <?php
      ...
      $num = 1;
      foreach (ordersGetAllData($filters=['Tipus'=>M_LAKOSSAGI, 'Statuszok'=>  'gyarthato']) as $i) {
