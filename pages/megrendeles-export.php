...
orderTable($filters=$f, $customerON = true, $customerDetailsON = true, $globStatusEditON = true, $orderStatusEdit = true, $shippingON = true, $priceON = true, $paymentON = true, $editButtonON = false, $trashButtonON = true, $shippingEditON = false, $shippingPriceEditON = true);
