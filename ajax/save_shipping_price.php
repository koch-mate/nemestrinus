...
<?php
    ...
    logEv(LOG_EVENT['order_shipping_price_update'].':',null,implode(', ', ['ID: '.$_POST['ID'],'Szállítási díj: '.$_POST['SzallitasiDij']]));
    orderShippingPriceUpdate($_POST['ID'],$_POST['SzallitasiDij']);
} ?>
